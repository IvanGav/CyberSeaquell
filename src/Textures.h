...
void load_all() {
	...
	load_png(&cam[5], "resources/textures/cam6.png"sa);
	load_png(&cam[6], "resources/textures/cam7.png"sa);
	load_png(&cam[7], "resources/textures/cam8.png"sa);
	load_png(&cam[8], "resources/textures/cam9.png"sa);
	load_png(&cam[9], "resources/textures/camA.png"sa);
	load_png(&cam[10], "resources/textures/camB.png"sa);
	load_png(&cam[11], "resources/textures/camC.png"sa);
	load_png(&cam[12], "resources/textures/camD.png"sa);
	load_png(&cam[13], "resources/textures/camE.png"sa);
